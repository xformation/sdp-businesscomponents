...
@RequestMapping(path = IApiController.API_PATH
		+ IApiController.URL_RECOM, method = RequestMethod.POST)
public class RecommendationController implements IApiController {

	private static final Logger logger = LoggerFactory
			.getLogger(RecommendationController.class);
